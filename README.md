...
### In the browser
Open the [live demo](https://jorge-sf.github.io/BCF_Editor/index.html), or download `BCF_Editor.html` and open it locally. Everything runs client-side — nothing is uploaded, and it works offline.
